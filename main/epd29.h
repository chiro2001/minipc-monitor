...
#define EPD29_BUSY_VAL 0
#else
#error "select display driver plz"
#endif

#if defined(EPD_CHIP_SSD1680) || defined(EPD_CHIP_UC8151D)
#define EPD29_WIDTH 128
#define EPD29_HEIGHT 296
#elif defined(EPD_CHIP_UC8179)
#define EPD29_WIDTH 480
#define EPD29_HEIGHT (648/4)
#endif
